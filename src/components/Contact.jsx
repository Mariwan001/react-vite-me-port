...
const Contact = () => {
  return (
    <div className='px-6 max-w-[1000px] mx-auto  grid md:grid-cols-2 place-items-center' id="contact">
            ...
            <div>
                <div className="p-2">
                    <div className="text-gray-300 my-3">
                        ...
                        Beyond coding, I am dedicated to continuous learning and staying up-to-date with the latest industry trends and best practices. I believe in writing clean, maintainable code and am always eager to explore new technologies and methodologies to enhance my craft.
                        </p>     
                    </div>
                </div> 
            ...
            <form action="https://getform.io/f/bvrepvwb" method="POST" 
